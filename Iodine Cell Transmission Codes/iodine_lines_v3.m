...
h = msgbox('Select ','Select needle position','help')
uiwait(h);
...
h = msgbox('Select needle position: draw a box over a part of the needle (from left to right), this will find the centerline and estimates the pixel size. Double Click in box after selection!','Select needle position','help')
uiwait(h);
